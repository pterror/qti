		...
		StackLayout {
			...
			ColumnLayout {
				...
				GridView {
					...
					delegate: GameDelegate { width: gamesGrid.cellWidth; height: gamesGrid.cellHeight }
				}
			}
			...
			ColumnLayout {
				...
				GridView {
					...
					delegate: GameDelegate { width: installedGrid.cellWidth; height: installedGrid.cellHeight }
				}
			}
